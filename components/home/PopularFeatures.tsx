  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="mb-10 flex justify-center">
        <div className="content-type-toggle relative w-80 bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-full grid grid-cols-2 backdrop-blur-2xl shadow-lg ring-1 ring-white/10 overflow-hidden">
          {/* Sliding Indicator - 使用百分比定位，不受 TV 模式 padding 干扰 */}
          <div
            className="absolute rounded-full bg-[var(--accent-color)] transition-all duration-400 cubic-bezier(0.4, 0, 0.2, 1) shadow-[0_0_15px_rgba(0,122,255,0.4)] pointer-events-none"
            style={{
              top: '4px',
              bottom: '4px',
              width: 'calc(50% - 4px)',
              left: contentType === 'movie' ? '4px' : 'calc(50%)',
            }}
          />
