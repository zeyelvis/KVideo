...
export function Navbar({ onReset, isPremiumMode = false, onSearch, onClearSearch, initialQuery = '', isSearching = false }: NavbarProps) {
    ...
    const handleSearch = (query: string) => {
        onSearch?.(query);
        setMobileSearchOpen(false); // 搜索后收起移动端搜索框
    };
